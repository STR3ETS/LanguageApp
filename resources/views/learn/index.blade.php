    ...
    <div class="py-8 lg:py-10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="font-display text-2xl font-bold text-bright">Your languages</h1>
                    <p class="text-sm text-muted mt-1">Pick a language to continue learning.</p>
                </div>
                ...
                @foreach($languageProgress as $lp)
                    ...
                    <div class="relative rounded-2xl overflow-hidden min-h-[280px] flex flex-col group">
                        <div class="absolute inset-0">
                            <img src="{{ $lm['img'] }}" alt="{{ $lp->language->name }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy">
                        ...
                        <div class="relative p-4">
                            <div class="inline-flex items-center gap-2 px-3 py-1.5 glass rounded-full">
                                ...
                                <span class="text-xs font-semibold text-bright">{{ $lp->language->name }}</span>
                            </div>
                        </div>
