...
@section('content')
    <div class="py-8 lg:py-10">
        <div class="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            {{-- Header --}}
            <div class="mb-8">
                <h1 class="font-display text-2xl font-bold text-bright">Profile</h1>
            ...
            <div class="space-y-5">
                ...
                <div class="glass-card rounded-2xl p-6 sm:p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="font-display text-base font-bold text-bright">Account information</h2>
                    </div>
                    <div class="max-w-xl">
                ...
                <div class="glass-card rounded-2xl p-6 sm:p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="font-display text-base font-bold text-bright">Password</h2>
                    </div>
                    <div class="max-w-xl">
                ...
                <div class="glass-card rounded-2xl p-6 sm:p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="font-display text-base font-bold text-bright">Subscription</h2>
                    </div>
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-sm text-bright font-semibold">Free plan</div>
                ...
                <div class="glass-card rounded-2xl p-6 sm:p-8 border-danger/10">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="font-display text-base font-bold text-bright">Danger zone</h2>
                    </div>
                    <div class="max-w-xl">
